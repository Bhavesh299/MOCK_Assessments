...
//   var puppy_Array = [];
  const Show_details = (data) => {
    ...
    // container.innerHTML = "" ;
   var drop_Container =  document.getElementById("mainmap_div2") ;
//    container.innerHTML = "" ;
   var Div = document.createElement("div");
   Div.setAttribute("id", "Dropdown_div");
